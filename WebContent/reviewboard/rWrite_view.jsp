...
<body>
	...
	<div id="content">
		<form action="${conPath }/rWrite.do" method="post"
				...
				<div class="head">
					<table>
						<tr>
							...
							<td style= "border-top:2px solid gray; border-bottom: 1px solid gray; background-color: lightgray;"><input type="text" name="RTitle" required="required"
								size="30"></td>
						</tr>
					</table>
				</div>
					...
					<table>
						<tr>
							<td style= "border-top:1px solid gray; border-bottom: 2px solid gray;">
								...
								onclick="location.href='${conPath}/rList.do'">
					</table>
				</div>
			</div>
		</form>
